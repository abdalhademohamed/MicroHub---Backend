...
import { IsString, IsUUID, IsOptional, IsEmail, Length, IsBoolean } from 'class-validator';
...
export class UpdateEmployeeDto extends PartialType(CreateEmployeeDto) {
  ...
  @ApiProperty({
    description: 'The working hours of the employee, in a specific format or enum',
    example: '9AM - 5PM',
    required: false
  })
  @IsString()
