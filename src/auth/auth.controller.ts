...
export class AuthController {
  ...
  @Post("signin")
  @ApiOperation({ summary: 'Sign in a user and return access and refresh tokens' })
  @ApiResponse({ status: 200, description: 'Tokens successfully generated.', schema: { example: { accessToken: 'string', refreshToken: 'string' } } })
  ...
  @ApiQuery({ name: 'resettoken', type: String, description: 'The reset token' })
  ...
  @ApiResponse({ status: 200, description: 'New tokens successfully generated.', schema: { example: { accessToken: 'string', refreshToken: 'string' } } })
